...
public class AuthentificationController {
    ...
    private void ouvrirInscription() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/pharmago/views/Inscription.fxml"));
    ...
    private void ouvrirTableauBord() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/pharmago/views/TableauBord.fxml"));
            Parent root = loader.load();
