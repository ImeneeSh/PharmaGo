...
import org.pharmago.utils.Session;
...
public class MenuController implements Initializable {
    ...
    private void navigateToTableauBord() {
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/org/pharmago/views/TableauBord.fxml"));
    ...
    private void navigateToConsultationGlobale() {
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/org/pharmago/views/ConsultationGlobale.fxml"));
            Parent root = fxmlLoader.load();
    ...
    private void ouvrirGestionClients() {
        try {
            ...
            URL fxmlUrl = getClass().getResource("/org/pharmago/views/GestionClients.fxml");
            if (fxmlUrl == null) {
    ...
    private void ouvrirGestionMedicaments() {
        try {
            ...
            URL fxmlUrl = getClass().getResource("/org/pharmago/views/GestionMedicaments.fxml");
            if (fxmlUrl == null) {
    ...
    private void ouvrirGestionLivraisons() {
        try {
            ...
            URL fxmlUrl = getClass().getResource("/org/pharmago/views/GestionLivraisons.fxml");
            if (fxmlUrl == null) {
    ...
    private void ouvrirGestionUtilisateurs() {
        try {
            ...
            // Charger le fichier FXML de la page Gestion des clients
            URL fxmlUrl = getClass().getResource("/org/pharmago/views/GestionUtilisateurs.fxml");
            if (fxmlUrl == null) {
